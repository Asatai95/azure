...
// チャット入力確認後に送信ボタン表示
$(function() {
  if ( $('.chat_room > .chat-message-input-text').val() == "" ) {
    $('.chat_room > #chat-message-submit').attr('disabled', 'disabled');
  }
  $('.chat_room > .chat-message-input-text').bind('keydown keyup keypress change', function() {
...
//$(function(){
// $("textarea[name='company']").on("keyup", function(){
//    var company = $("#chat-message-input-c").val();
//    console.log(company)
//    var user = $("#chat-message-input-u").text();
//    console.log(user)
//    $("#chat-message-submit").on("click", function(){
//      console.log(company)
// });
